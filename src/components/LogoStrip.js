...
export default function LogoStrip() {
  return (
    <section className="py-10 overflow-hidden" style={{ borderBottom: '1px solid var(--border)' }}>
      <p className="text-center text-xs font-semibold mb-6 tracking-widest uppercase" style={{ color: 'var(--ink-faint)' }}>
        Top companies freshers are targeting with JobReady
      </p>
